...
public class matrixMULTIPLICATIONinput
{
    public static void main(String args[])
    {
        ...
        System.out.println("Enter the no.of rows for MATRIX 1 : ");               // ROW 1 input
        int r1 = sc.nextInt();

        System.out.println("Enter the no.of columns for MATRIX 1 : ");                          // COLUMN 1 input
        int c1 = sc.nextInt();
  
        System.out.println("Enter the no.of rows for MATRIX 2 : ");              // ROW 2 input 
        int r2 = sc.nextInt();

        System.out.println("Enter the no.of columns for MATRIX 2 : ");                         // COLUMN 2 input
        int c2 = sc.nextInt();
